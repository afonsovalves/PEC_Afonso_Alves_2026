...
void loop() {
  if (!cicloConcluido) {
    ...
    if (peso_calculado < LIMIAR_PESO) {
      ...
      analogWrite(IMAN_PIN, 128);
      controladorServos.moveServo(1, SERVO_MIN, 0.5*TEMPO_MOVIMENTO);
      controladorServos.moveServo(2, SERVO_MIN, 0.5*TEMPO_MOVIMENTO);
      controladorServos.moveServo(3, SERVO_MAX, 0.5*TEMPO_MOVIMENTO);
      controladorServos.moveServo(2, SERVO_MAX, 0.5*TEMPO_MOVIMENTO);
      controladorServos.moveServo(3, SERVO_MIN, 0.5*TEMPO_MOVIMENTO);
      digitalWrite(IMAN_PIN, LOW);
      controladorServos.moveServo(1, 500, 0.4*TEMPO_MOVIMENTO);
      controladorServos.moveServo(2, 500, 0.4*TEMPO_MOVIMENTO);
      controladorServos.moveServo(3, 500, 0.4*TEMPO_MOVIMENTO);
      ...
      controladorServos.moveServo(2, SERVO_MAX, TEMPO_MOVIMENTO);
      controladorServos.moveServo(3, SERVO_MIN, TEMPO_MOVIMENTO);
      digitalWrite(IMAN_PIN, LOW);
      controladorServos.moveServo(1, 500, 0.4*TEMPO_MOVIMENTO);
      controladorServos.moveServo(2, 500, 0.4*TEMPO_MOVIMENTO);
      controladorServos.moveServo(3, 500, 0.4*TEMPO_MOVIMENTO);
